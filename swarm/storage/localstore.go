...
func NewLocalStore(hash SwarmHasher, params *StoreParams, psql bool, psqlTableName string) (*LocalStore, error) {
	dbStore, err := NewDbStore(params.ChunkDbPath, hash, params.DbCapacity, params.Radius, psql, psqlTableName)
	if err != nil {
		return nil, err
	}
	return &LocalStore{
